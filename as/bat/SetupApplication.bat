...
:: Android packaging
set AND_CERT_NAME="G2S-InAppPurchase"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\G2SInAppPurchase.p12
...
set IOS_PROVISION=cert\G2SInAppPurchase.mobileprovision
...
set APP_ID=air.G2SInAppPurchase

:: Output packages
set DIST_PATH=dist
set DIST_NAME=G2SInAppPurchase
